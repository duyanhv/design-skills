...
| [**material-3**](skills/material-3/) | Google Material Design 3 work on Compose, Material Web, or another implementation: theming, component states, adaptive layout | [`SKILL.md`](skills/material-3/SKILL.md) routes by task to five guides — [theming](skills/material-3/references/tasks/theming.md), [components](skills/material-3/references/tasks/components.md), [layout](skills/material-3/references/tasks/layout.md), [typography](skills/material-3/references/tasks/typography.md), [accessibility](skills/material-3/references/tasks/accessibility.md) — plus a [source map](skills/material-3/references/research/sources.md) with per-platform notes, an [evidence workflow](skills/material-3/references/review/evidence.md), `provenance.json` | [Review](examples/material-3-review/) · [Build](examples/material-3-build/) |
| [**accessibility-claims**](skills/accessibility-claims/) | Writing or reviewing an accessibility finding, audit, or conformance claim, on any platform. A method for making claims, **not** a copy of WCAG and not a conformance standard | [`SKILL.md`](skills/accessibility-claims/SKILL.md) routes by question to four guides — [authority](skills/accessibility-claims/references/tasks/authority.md) (normative, informative, or vendor), [criteria](skills/accessibility-claims/references/tasks/criteria.md) (conditions and exceptions), [evidence](skills/accessibility-claims/references/tasks/evidence.md) (what a source read does and does not establish), [reporting](skills/accessibility-claims/references/tasks/reporting.md), `provenance.json` | [Review of an audit](examples/accessibility-claims-review/) |
